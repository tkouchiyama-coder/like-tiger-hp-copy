...
(function () {
  ...
  var TRAVEL_LOG = {
    ...
    "マカオ": {
      author: "けんと",
      story:  "香港からフェリーで小一時間。ポルトガル統治時代の石畳と、世界最大級のカジノ街が同居する不思議な街。歩いているだけで文化のミックス感に驚かされました。",
      spots:  ["聖ポール天主堂跡", "セナド広場", "ザ・ヴェネチアン・マカオ"],
      food:   ["エッグタルト", "ポークチョップバーガー", "アフリカンチキン"],
      tip:    "1〜2日で十分回れるので、香港と組み合わせるのが定番。夜のホテル群のライトアップは必見。"
    },
